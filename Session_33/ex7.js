let products = [
    ...
    },
    {
        ...
        image: 'https://bizweb.dktcdn.net/100/356/047/products/airpods-pro-2-jpeg.jpg?v=1685453688050',
        price: 7490000
    },
    {
    ...
    },
    {
        ...
        image: 'https://product.hstatic.net/1000233206/product/logitech-g-pro-x-mechanical-gaming-keyboard_2-600x400_0472fe2fcf3640dd8836c1fed7377043_grande.jpg',
        price: 2490000
    },
    {
...
let productsElement = document.querySelector('.products-grid');
let cartTotalElement = document.querySelector('.cart-total');
let checkoutElement = document.querySelector('.checkout-btn');
...
function addToCart(index){
    let indexCart = cart.findIndex(item => item.name === products[index].name);
...
checkoutElement.addEventListener('click', function(){
    if(cart.length === 0){
        ...
        alert(`Thanh toan thanh cong so tien ${total.toLocaleString('vi', {style: 'currency', currency: 'VND'})}`);
        cart = [];
        cartItemsElement.innerHTML = `<div class="empty-cart">Giỏ hàng trống</div>`
